...
public class Order {
  ...
  // object is a group of set of data
  // checkoutAmount, below is not beautiful
  // private double[] prices;
  // private int[] quantities;

  // Alternative
  private Item[] items;
  private double couponTenPercentOff = 0.9;
  ...
  public double checkoutAmount() {
    ...
    if (total >= 100) { // order level discount
      total -= total * couponTenPercentOff;
    }
    return total;
  }
